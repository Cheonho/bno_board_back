...
public interface BoardService {
    ...
    ResponseEntity<? super PostWriteBoardResponseDto> postWriteBoard(WriteBoards board, List<MultipartFile> files);
    ResponseEntity<? super PutUpdateBoardResponseDto> putUpdateBoard(UpdateBoards board, List<MultipartFile> files, List<String> deleteIdList);
